...
dyn_rpro <- Csnippet("
                      ...
                      //------------Si-------------
                      Si_term = lambda_Ji * Ji * dt - theta_Si * Si * dt -  probn * f_Si * Si * P * dt - delta * Si * dt + Si * noiSi;
                        
                      //-----------Ji-------------
                      
                      Ji_term = ri * f_Si * F * Si  * dt  -  lambda_Ji * Ji * dt - theta_Ji * Ji * dt - delta * Ji * dt + Ji * noiJi;
                      ...
                      F_term =  F * noiF - f_Si * F * (Si + xi * Ii + xi_J * Ji) * dt - delta * F * dt + 0.37 * dt;
...
pt <- parameter_trans(
  ...
  log = c( "sigSi", "sigIi", "sigF","sigP","f_Si",
           ...
           "theta_Si","theta_Ii","theta_P","theta_Ji","xi","lambda_Ji","xi_J")
)
...
parameters =  c( "sigSi" = 0.1, "sigIi"= 0.1, "sigF"= 0.1,"sigP"= 0.1,"f_Si"= 0.01,
                 ...
                 "theta_Si"= 0.1,"theta_Ii"= 0.1,"theta_P"= 0.1,"theta_Ji"= 0.1,"xi"= 1,"lambda_Ji" = 0.1, "xi_J" = 1)
...
generate_parameter_profile <- function(prof_name, nprof = 80) {
  shared_ub <- c(
    sigSi = 2.347864e-01, sigIi = 3.990774e+00, sigF = 9.556734e-05, sigP = 5.099504e-01,
    f_Si = 3.342145e-02, ri = 1.141240e+03, k_Ii = 1.576292e+01, k_Si = 1.434550e+04,
    sigJi = 3.811261e+00, probn = 1.761644e+00, theta_Si = 4.984252e+00, theta_Ii = 3.066449e+00,
    theta_P = 1.215404e-03, theta_Ji = 4.623278e-02, xi = 1.873358e+02, lambda_Ji = 3.406072e-01,
    xi_J = 6.630892e-01
  )
