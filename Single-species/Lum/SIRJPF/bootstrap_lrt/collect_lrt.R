...
# Row name mapping: alt_name -> row name in lum_para_parameter_table
# The table has row names: all_shared, xi, theta_Si, theta_P, theta_Ii, probi, ri, f_Si
# (sorted by AIC, so use row names not numeric indices)
row_map <- list(
  xi       = "xi",
  theta_Si = "theta_Si",
  theta_Ii = "theta_Ii",
...
for (alt in alt_names) {
  ...
  p_chisq <- lum_para_parameter_table[row_name, "lrt_pval"]
