...
dyn_rpro <- Csnippet("
                      ...
                      //------------Si-------------
                      Si_term = lambda_Ji * Ji * dt - theta_Si * Si * dt -  delta * Si * dt + Si * noiSi;
                      ...
                      F_term =  F * noiF - f_Si * F * (Si + xi_J * Ji) * dt  - delta * F * dt + 0.37 * dt;
...
pt <- parameter_trans(
  log = c( "sigSi","sigF","f_Si",
           "ri","k_Si","sigJi",
           "theta_Si","theta_Ji","lambda_Ji","xi_J")
)
...
parameters=  c( "sigSi" = 0.1, "sigF"= 0.1,"f_Si"= 0.1,
                ...
                "theta_Si"= 0.1,"theta_Ji"= 0.1,"lambda_Ji" = 0.1,"xi_J" = 0.1)
...
generate_parameter_profile <- function(prof_name, nprof = 80) {
  shared_ub <- c(
    sigSi = 1.088819e+00, sigF = 3.357427e-02, f_Si = 4.219797e-02, ri = 2.155868e+02,
    k_Si = 2.167213e+01, sigJi = 3.138598e+00, theta_Si = 4.767221e+00, theta_Ji = 1.247213e-02,
    lambda_Ji = 1.538031e+00, xi_J = 4.806117e-04
  )
