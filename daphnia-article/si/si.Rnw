...
A tutorial on the pomp implementation of our ecological model and data analysis is available at \url{https://github.com/Megumi-ybb/Daphnia-tutorial}.
A similar tutorial, written in Python/JAX using Pypomp, is available at \url{https://github.com/pypomp/daphnia}.
