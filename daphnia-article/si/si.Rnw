...
A tutorial on the pomp implementation of our ecological model and data analysis is at \url{https://github.com/Megumi-ybb/Daphnia-tutorial}, and archived at Zenodo \eic{WHEN READY}.
A similar tutorial, but written in Python/JAX using Pypomp, is at \url{https://github.com/pypomp/daphnia}, and archived at Zenodo \eic{WHEN READY}.
