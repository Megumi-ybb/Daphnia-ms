...
\author{Bo Yang$^1$, Jesse Wheeler$^{2,5}$, Meghan A. Duffy$^3$, Aaron A. King$^{3,4}$ \\ and Edward L. Ionides$^2$\\
...
\\
\authoraddress $^5$Idaho State University, Department of Mathematics and Statistic}
  \maketitle
} \fi
