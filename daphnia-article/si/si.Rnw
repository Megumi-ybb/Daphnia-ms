...
{\small
\begin{align}
    dS^{\species}_{\unit}(t) &= \lambda^{\species}_{J,{\unit}} J^{\species}_{\unit}(t) \, dt - \big\{\theta^{\species}_{S,{\unit}} + p^{\species}_{\unit} f^{\species}_{S,{\unit}} P_{\unit}(t) + \delta \big\} S^{\species}_{\unit}(t)\, dt, \label{eq:SIRJPF_dS}\\
...
$\sigma^{\native}_{S}$ & Standard deviation of Brownian motion of susceptible adult      &   $\sqrt{\mathrm{individual} \cdot \mathrm{day}^{-1}}$  & \Sexpr{mysignif(sigSn,2)}  & (\Sexpr{0},\,\Sexpr{mysignif(ci_table$sigSn[2],2)})\\
...
$\mu$           & Algae refilling rate                                &  $10^6 \cdot \mathrm{cell} \cdot \mathrm{L} ^{-1} \cdot \mathrm{day}^{-1}$                 & \Sexpr{mysignif(mu,2)} & \\
$\delta$        & Sampling rate                                      &  $day ^{-1}$                                                                         & \Sexpr{mysignif(delta,2)} & \\
$\sigma^{\invasive}_{S}$ & Standard deviation of Brownian motion of susceptible adult      &   $\sqrt{\mathrm{individual} \cdot \mathrm{day}^{-1}}$  & \Sexpr{mysignif(sigSi,2)}  & (\Sexpr{0},$\infty$)\\
...
{\small
\begin{align}
    dS^{\species}_{\unit}(t) &= \lambda^{\species}_{J,{\unit}} J^{\species}_{\unit}(t) \, dt - (\theta^{\species}_{S,{\unit}} + \delta) S^{\species}_{\unit}(t)\, dt , \label{eq:SRJF2_dS}\\
...
$\delta$        & Sampling rate                                      &  $day ^{-1}$                                                                         & \Sexpr{mysignif(delta,2)} & \\
$\sigma^{\native}_{S}$ & Standard deviation of Brownian motion of susceptible native adult      &   $\sqrt{\mathrm{individual} \cdot \mathrm{day}^{-1}}$  & \Sexpr{mysignif(sigSn,2)}  & (\Sexpr{0},\Sexpr{mysignif(ci_table$sigSn[2],2)})\\
...
{\small
\begin{align}
    dS^{\species}_{\unit}(t) &= \lambda^{\species}_{J,{\unit}} J^{\species}_{\unit}(t) \, dt - (\theta^{\species}_{S,{\unit}} + \delta) S^{\species}_{\unit}(t)\, dt , \label{eq:SRJF_dS}\\
...
$\mu$           & Algae refilling rate                                &  $10^6 \cdot \mathrm{cell} \cdot \mathrm{L} ^{-1} \cdot \mathrm{day}^{-1}$                 & \Sexpr{mysignif(mu,2)} & \\
$\delta$        & Sampling rate                                      &  $day ^{-1}$                                                                         & \Sexpr{mysignif(delta,2)} & \\
$\sigma^{\invasive}_{S}$ & Standard deviation of Brownian motion of susceptible adult      &   $\sqrt{\mathrm{individual} \cdot \mathrm{day}^{-1}}$  & \Sexpr{mysignif(sigSi,2)}  & (\Sexpr{0},\Sexpr{mysignif(ci_table$sigSi[2],2)})\\
