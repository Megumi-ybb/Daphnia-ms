...
For the fourteen-parameter alternatives (38 parameters in unit-specific model and 24 parameters in all-shared model) the simulated $\Lambda$ does not sit near the $\chi^2_{14}$ mean of $14$: its average across these alternatives is about $27$, ranging from roughly $16$ for $\theta_S$ to $36$ for $r$.
