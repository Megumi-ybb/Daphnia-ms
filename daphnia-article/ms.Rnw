...
\and
\author[B]{\fnms{Edward}~\snm{Ionides}\ead[label=e5]{ionides@umich.edu}}

\address[A]{Department of Biostatistics, University of Michigan \printead[presep={,\ }]{e1}}
\address[B]{Department of Statistics, University of Michigan\printead[presep={,\ }]{e2,e5}}
\address[C]{Department of Ecology and Evolutionary Biology, University of Michigan \printead[presep={,\ }]{e3,e4}}
% \address[D]{Center for the Study of Complex Systems, University of Michigan\printead[presep={,\ }]{e4}}
\end{aug}
} \fi
...
The corresponding author is Bo Yang.
Jesse Wheeler is also affiliated with the Department of Mathematics and Statistics, Idaho State University.
...
\sdescription{Code and data for the analysis is available at the Github repository: https://github.com/Megumi-ybb/Daphnia-ms or https://doi.org/10.5281/zenodo.15595669.}
\end{supplement}
\begin{supplement}
\stitle{Supplementary Material}
\sdescription{The Supplementary Material includes detailed Panel Iterated Filtering algorithm and the benchmark model specifications.
