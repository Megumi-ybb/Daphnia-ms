...
(i) the lower density of \textit{D. lumholtzi} which may increast stochastic effects;
...
Code and data for the analysis is available at the Github repository: https://github.com/Megumi-ybb/Daphnia-ms or https://doi.org/10.5281/zenodo.15522754.
