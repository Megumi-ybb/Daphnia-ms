...
\jwc{This paragraph is quite long, could we shorten it?}
...
\jwc{Perhaps split the paragraph here?}
...
\jwc{The following paragraph is quite long. Could we split it in two parts?}
...
\jwc{Suggestion: Rather than ``This could arise" I suggest: ``This may be explained" or similar, because this result \emph{did} arise, we are just trying to explain why.}
