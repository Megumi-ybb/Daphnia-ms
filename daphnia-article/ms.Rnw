...
Code and data for the analysis is available on Github at \url{https://github.com/Megumi-ybb/Daphnia-ms} and is archived on Zenodo at \url{https://doi.org/10.5281/zenodo.21702761}.
