...
$\sigma^{\native}_{S}$ & Standard deviation of Brownian motion of susceptible native adult         &   $\sqrt{\mathrm{individual} \cdot \mathrm{day}^{-1}}$  & 0  & \revision{\editSetToZero} \\
$\sigma^{\invasive}_{S}$ & Standard deviation of Brownian motion of susceptible invasive adult         &   $\sqrt{\mathrm{individual} \cdot \mathrm{day}^{-1}}$  & 0  & \revision{\editSetToZero} \\
