...
# ggplot(dentNoPara,aes(x=day,y=dentadult))->ggp1
# ggp1 +
#   geom_line(data=dentNoPara,aes(x=day,y=dent.adult)) +
#   facet_wrap(~rep,scales="free")+labs(y = "Daphnia adult density")

# ggplot(dentNoPara,aes(x=day,y=infadult))->ggp2
# ggp2 +
#   geom_line(data=dentNoPara,aes(x=day,y=dent.inf)) +
#   facet_wrap(~rep,scales="free")+labs(y = "Daphnia adult infected")
...
parameters = c(
  ...
  theta_Ii = 0.3531879, theta_In = 0.5489315, theta_P = 0.02024991, sigSn = 0.008193153, sigSi = 0.06680862, sigIn = 0.0003063207,
