...
The manuscript is self-contained and can be generated by knitting the `./daphnia-article/ms.Rnw` file. You will first need to install the following R packages, if you don't already have them.

```
install.packages(c('knitr','patchwork','readxl','pomp',
    'panelPomp','foreach','doParallel','gridExtra','tidyverse'))
```
...
**[https://github.com/pypomp/Daphnia-tutorial] (DOI: https://doi.org/10.5281/zenodo.21676670)**
